...
const TopRouteIndicator = ({ name = '',icon}: ITopRouteIndicatorProps) => {
	...
	return (
		<div className='border-b border-b-gray-300 pb-7 pt-9'>
			<div className='mx-4 flex  justify-end items-center gap-6'>
				{icon === 'arrow' ?
				<Link className='flex-shrink-0' href={`${Routes.Categories}/${categoryId}/pairwise-ranking/ranking-list/edit`}>
				 {iconMap[icon]}
				</Link>
				 :''}
