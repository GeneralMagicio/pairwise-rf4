...
const CategoryItem = ({ category, progress, imageNumber }: ICategoryProps) => {
	...
	return (
		<div
			className='flex cursor-pointer items-center justify-between gap-2 border-b border-b-gray-300  px-3 py-3'
		...
		>
			...
			<div className='flex flex-1 flex-col'>
				...
				<p className=' text-text-placeholder font-inter self-stretch text-sm font-normal leading-[18px] tracking-[-0.011px] text-ph'>
