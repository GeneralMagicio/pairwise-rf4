...
const CategoriesPage = () => {
	...
	const {data: categoryPairs, isLoading: isGettingCategoryPairs} = useGetCategoryPairs()
	...
	return (
		<div className='px-4'>
			<CategoryPairwiseModal isOpen={isModalOpen} close={closeModal} handleSubmit={handleSubmit}/>
